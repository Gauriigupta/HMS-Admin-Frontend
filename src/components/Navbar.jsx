    ...
    return(
        <div className="flex justify-between items-center px-4 sm:px-10 border-b bg-white">
            <div className="flex items-center gap-2 text-xs">
                <img className="w-36 sm:w-44 cursor-pointer " src="/src/assets/MediCare (2).png" alt="" />
                <p className="border px-2 py-1 rounded-full border-gray-600 text-gray-700">{aToken?'Admin':'Doctor'}</p>
            </div>
